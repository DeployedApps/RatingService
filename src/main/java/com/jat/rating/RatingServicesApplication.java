...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "This is  Rating Microservices. Please Choose another microservice from dropdown of main Document Server.", version = "3.0", description = "It contains & create Rating Information from different users to Hotels assigned during their stay. API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 

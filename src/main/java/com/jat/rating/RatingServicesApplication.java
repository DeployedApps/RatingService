...
@EnableEurekaClient
@OpenAPIDefinition(info = @Info(title = "***  Rating Microservices   *** \nPlease Choose another spec from dropdown for other services from main Document Server API Gatway", version = "3.0", description = "It contains & create Rating Information from different users to Hotels assigned during their stay. API is powered by salient features of Spring Boot e.g. [resilence4j](!https://resilience4j.readme.io/docs),"+ 
